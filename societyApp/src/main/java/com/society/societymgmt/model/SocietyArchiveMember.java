...
@Entity
public class SocietyArchiveMember implements Serializable{
	...
	public SocietyArchiveMember() {
		
	}
	
	public SocietyArchiveMember(@Size(max = 2) String building, @Size(max = 3) String flatNo, @Size(max = 2) String shopNo) {
	...
	public SocietyArchiveMember(@Size(max = 2) String building, @Size(max = 3) String flatNo, @Size(max = 2) String shopNo,
			...
			String mobileNo, @Email String primaryEmail, boolean isCurrentlyStaying) {
		super();
		this.building = building;
		this.flatNo = flatNo;
		this.shopNo = shopNo;
